...
def create_position_clip(
	...
	clip1 = mp.VideoFileClip(clip_path, target_resolution=(1080, 1920))
...
def create_last_out_clip(
	...
	music_clip = mp.VideoFileClip(clip_path, target_resolution=(1080, 1920)) \
	...
	blurred_clip = mp.CompositeVideoClip([
		music_clip,
		clip_chart_number,
		clip_chart_date,
		clip_logo,
